...
// 感謝 小了白了兔
//源码来自https://raw.githubusercontent.com/Yswag/showtime-extensions/refs/heads/main/js/jpyy.js
//仅修改配置网址
...
async function getVideosByCategory(categoryId, page, sort) {
    ...
    if (!category) return [];
    const extObj = Object.assign({}, (category && category.ext) ? category.ext : {}, { page: page || 1, filters: { sort: sort || '2' } });
